      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {projects.map((project, i) => (
            ...
            >
              <div
                className={`relative overflow-hidden rounded-2xl ${project.color} p-8 lg:p-10 min-h-[400px] flex flex-col justify-between transition-all duration-500 ${hoveredProject && hoveredProject !== project.id
                    ? "opacity-50"
                    : ""
                  }`}
              >
