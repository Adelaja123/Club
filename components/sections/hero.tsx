  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I&apos;m <span className="text-foreground font-medium">Oluwagbotemi Adelaja</span> - a full-stack developer passionate about creating elegant, 
          performant, and user-centric web applications that make a lasting impact.
        </motion.p>
